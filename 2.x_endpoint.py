...
data = pd.read_csv('Data_actual_out/FINAL_nongranted_owners_country_industry.csv')
...
# Save to a CSV file
aggregated_data.to_csv('Data_actual_out/FINAL_couind_aggregated_nongranted.csv', index=False)